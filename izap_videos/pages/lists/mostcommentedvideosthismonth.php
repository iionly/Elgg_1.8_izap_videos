...
elgg_push_breadcrumb(elgg_echo('izap_videos:mostcommentedthismonth'));
...
$title = elgg_echo('izap_videos:mostcommentedthismonth');
...
if (!empty($result)) {
	...
	$area2 = elgg_echo('izap_videos:mostcommentedthismonth:nosuccess');
}
...
// Draw it
echo elgg_view_page(elgg_echo('izap_videos:mostcommentedthismonth'), $body);
